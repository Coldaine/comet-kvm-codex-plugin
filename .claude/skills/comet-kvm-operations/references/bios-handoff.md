...
The server manages transport automatically; the general skill covers target
selection and generic operations, while the BIOS skill chooses semantic
firmware observation and actions. After the firmware-specific portion, return
