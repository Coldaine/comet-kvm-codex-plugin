...
The KVM MCP server is a hardened fork of `kennypeh85/glkvm-mcp` that exposes a GL.iNet Comet-family KVM's keyboard, mouse, screenshot, OCR, and hardware-control capabilities as MCP tools.
